...
class stratos_is ( $offset=0, $tribes_port=4000, $config_db=governance, $maintenance_mode=true ) inherits system_config {
	
	$service_code = "is"
	$service_dir = "wso2stratos-$service_code-$stratos_version"	
	$service_templates = ["registry.xml","axis2.xml","carbon.xml","advanced/authenticators.xml","sso-idp-config.xml"]
